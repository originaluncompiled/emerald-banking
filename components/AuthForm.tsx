    ...
    return (
        <section className='auth-form'>
            <header className='flex flex-col gap-5 md:gap-8'>
                ...
                <div className='flex cursor-pointer item-center gap-1'>
                    <Image src='/icons/logo.svg' width={34} height={34} alt='Emerald Logo'/>
                            ...
                            {type === 'sign-up' && (
                                <>
                                    ...
                                    <div className='flex gap-4'>
                                        ...
                                        <FormInput control={form.control} name='postalCode' label='Postal Code' placeholder='ex: 11101' />
                                    </div>
                                    <div className='flex gap-4'>
                                        <FormInput control={form.control} name='dateOfBirth' label='Date of Birth' placeholder='yyyy-mm-dd' />
                                        <FormInput control={form.control} name='ssn' label='SSN' placeholder='ex: 123456789' />
                                    </div>
                                </>
                            )}
